...
/* --------------------------------- Process Tweaks -------------------------*/
    ...
    while (iters) {
        ...
        X = XOR(XOR(X, States[0]), tkp[index + 1]);
...
/*-----------------------Process Plaintexts----------------------------*/
    ...
    while (iters) {
        ...
        //Domain Seperateation indication: plaintext domain
        RT[0][0] = XOR(TWO, RT[0][0]);
        RT[0][1] = XOR(TWO, RT[0][1]);
        RT[0][2] = XOR(TWO, RT[0][2]);
        RT[0][3] = XOR(TWO, RT[0][3]);
        ...
        X = XOR(XOR(X, States[0]), ptp[index + 1]);
...
/*----------------------- Process Plaintexts ----------------------------*/
    ...
    while (iters) {
        ...
        X = XOR(XOR(X, States[0]), ctp[index + 1]);
